...
function webhook_api:webhook_create(entity, action, callback, label, fields, response_fields, active, lang_id, store_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/webhook.create.json?entity=%s&action=%s&callback=%s&label=%s&fields=%s&response_fields=%s&active=%s&lang_id=%s&store_id=%s",
			self.basePath, http_util.encodeURIComponent(entity), http_util.encodeURIComponent(action), http_util.encodeURIComponent(callback), http_util.encodeURIComponent(label), http_util.encodeURIComponent(fields), http_util.encodeURIComponent(response_fields), http_util.encodeURIComponent(active), http_util.encodeURIComponent(lang_id), http_util.encodeURIComponent(store_id));
	})
...
function webhook_api:webhook_update(id, callback, label, fields, response_fields, active, lang_id)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/webhook.update.json?id=%s&callback=%s&label=%s&fields=%s&response_fields=%s&active=%s&lang_id=%s",
			self.basePath, http_util.encodeURIComponent(id), http_util.encodeURIComponent(callback), http_util.encodeURIComponent(label), http_util.encodeURIComponent(fields), http_util.encodeURIComponent(response_fields), http_util.encodeURIComponent(active), http_util.encodeURIComponent(lang_id));
	})
