...
function product_api:product_brand_list(start, count, page_cursor, brand_ids, category_id, parent_id, store_id, lang_id, find_where, find_value, created_from, created_to, modified_from, modified_to, avail, response_fields, params, exclude)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/product.brand.list.json?start=%s&count=%s&page_cursor=%s&brand_ids=%s&category_id=%s&parent_id=%s&store_id=%s&lang_id=%s&find_where=%s&find_value=%s&created_from=%s&created_to=%s&modified_from=%s&modified_to=%s&avail=%s&response_fields=%s&params=%s&exclude=%s",
			self.basePath, http_util.encodeURIComponent(start), http_util.encodeURIComponent(count), http_util.encodeURIComponent(page_cursor), http_util.encodeURIComponent(brand_ids), http_util.encodeURIComponent(category_id), http_util.encodeURIComponent(parent_id), http_util.encodeURIComponent(store_id), http_util.encodeURIComponent(lang_id), http_util.encodeURIComponent(find_where), http_util.encodeURIComponent(find_value), http_util.encodeURIComponent(created_from), http_util.encodeURIComponent(created_to), http_util.encodeURIComponent(modified_from), http_util.encodeURIComponent(modified_to), http_util.encodeURIComponent(avail), http_util.encodeURIComponent(response_fields), http_util.encodeURIComponent(params), http_util.encodeURIComponent(exclude));
	})
...
function product_api:product_count(sku, product_ids, since_id, categories_ids, category_id, store_id, vendor_id, lang_id, avail_view, avail_sale, created_from, created_to, modified_from, modified_to, brand_name, manufacturer_id, product_attributes, status, type, visible, find_value, find_where, report_request_id, return_global, disable_report_cache, use_latest_api_version)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/product.count.json?sku=%s&product_ids=%s&since_id=%s&categories_ids=%s&category_id=%s&store_id=%s&vendor_id=%s&lang_id=%s&avail_view=%s&avail_sale=%s&created_from=%s&created_to=%s&modified_from=%s&modified_to=%s&brand_name=%s&manufacturer_id=%s&product_attributes=%s&status=%s&type=%s&visible=%s&find_value=%s&find_where=%s&report_request_id=%s&return_global=%s&disable_report_cache=%s&use_latest_api_version=%s",
			self.basePath, http_util.encodeURIComponent(sku), http_util.encodeURIComponent(product_ids), http_util.encodeURIComponent(since_id), http_util.encodeURIComponent(categories_ids), http_util.encodeURIComponent(category_id), http_util.encodeURIComponent(store_id), http_util.encodeURIComponent(vendor_id), http_util.encodeURIComponent(lang_id), http_util.encodeURIComponent(avail_view), http_util.encodeURIComponent(avail_sale), http_util.encodeURIComponent(created_from), http_util.encodeURIComponent(created_to), http_util.encodeURIComponent(modified_from), http_util.encodeURIComponent(modified_to), http_util.encodeURIComponent(brand_name), http_util.encodeURIComponent(manufacturer_id), http_util.encodeURIComponent(product_attributes), http_util.encodeURIComponent(status), http_util.encodeURIComponent(type), http_util.encodeURIComponent(visible), http_util.encodeURIComponent(find_value), http_util.encodeURIComponent(find_where), http_util.encodeURIComponent(report_request_id), http_util.encodeURIComponent(return_global), http_util.encodeURIComponent(disable_report_cache), http_util.encodeURIComponent(use_latest_api_version));
	})
...
function product_api:product_info(id, store_id, vendor_id, lang_id, currency_id, response_fields, params, exclude, report_request_id, disable_report_cache, use_latest_api_version)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/product.info.json?id=%s&store_id=%s&vendor_id=%s&lang_id=%s&currency_id=%s&response_fields=%s&params=%s&exclude=%s&report_request_id=%s&disable_report_cache=%s&use_latest_api_version=%s",
			self.basePath, http_util.encodeURIComponent(id), http_util.encodeURIComponent(store_id), http_util.encodeURIComponent(vendor_id), http_util.encodeURIComponent(lang_id), http_util.encodeURIComponent(currency_id), http_util.encodeURIComponent(response_fields), http_util.encodeURIComponent(params), http_util.encodeURIComponent(exclude), http_util.encodeURIComponent(report_request_id), http_util.encodeURIComponent(disable_report_cache), http_util.encodeURIComponent(use_latest_api_version));
	})
...
function product_api:product_list(start, count, page_cursor, product_ids, since_id, categories_ids, category_id, store_id, vendor_id, lang_id, currency_id, avail_view, avail_sale, created_from, created_to, modified_from, modified_to, sku, brand_name, product_attributes, manufacturer_id, status, type, visible, find_value, find_where, return_global, params, response_fields, exclude, sort_by, sort_direction, report_request_id, disable_cache, disable_report_cache, use_latest_api_version, product_type)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/product.list.json?start=%s&count=%s&page_cursor=%s&product_ids=%s&since_id=%s&categories_ids=%s&category_id=%s&store_id=%s&vendor_id=%s&lang_id=%s&currency_id=%s&avail_view=%s&avail_sale=%s&created_from=%s&created_to=%s&modified_from=%s&modified_to=%s&sku=%s&brand_name=%s&product_attributes=%s&manufacturer_id=%s&status=%s&type=%s&visible=%s&find_value=%s&find_where=%s&return_global=%s&params=%s&response_fields=%s&exclude=%s&sort_by=%s&sort_direction=%s&report_request_id=%s&disable_cache=%s&disable_report_cache=%s&use_latest_api_version=%s&product_type=%s",
			self.basePath, http_util.encodeURIComponent(start), http_util.encodeURIComponent(count), http_util.encodeURIComponent(page_cursor), http_util.encodeURIComponent(product_ids), http_util.encodeURIComponent(since_id), http_util.encodeURIComponent(categories_ids), http_util.encodeURIComponent(category_id), http_util.encodeURIComponent(store_id), http_util.encodeURIComponent(vendor_id), http_util.encodeURIComponent(lang_id), http_util.encodeURIComponent(currency_id), http_util.encodeURIComponent(avail_view), http_util.encodeURIComponent(avail_sale), http_util.encodeURIComponent(created_from), http_util.encodeURIComponent(created_to), http_util.encodeURIComponent(modified_from), http_util.encodeURIComponent(modified_to), http_util.encodeURIComponent(sku), http_util.encodeURIComponent(brand_name), http_util.encodeURIComponent(product_attributes), http_util.encodeURIComponent(manufacturer_id), http_util.encodeURIComponent(status), http_util.encodeURIComponent(type), http_util.encodeURIComponent(visible), http_util.encodeURIComponent(find_value), http_util.encodeURIComponent(find_where), http_util.encodeURIComponent(return_global), http_util.encodeURIComponent(params), http_util.encodeURIComponent(response_fields), http_util.encodeURIComponent(exclude), http_util.encodeURIComponent(sort_by), http_util.encodeURIComponent(sort_direction), http_util.encodeURIComponent(report_request_id), http_util.encodeURIComponent(disable_cache), http_util.encodeURIComponent(disable_report_cache), http_util.encodeURIComponent(use_latest_api_version), http_util.encodeURIComponent(product_type));
	})
