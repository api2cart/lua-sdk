...
-- customer_update_address_inner class
local customer_update_address_inner = {}
local customer_update_address_inner_mt = {
	__name = "customer_update_address_inner";
	__index = customer_update_address_inner;
}

local function cast_customer_update_address_inner(t)
...
return {
	cast = cast_customer_update_address_inner;
	new = new_customer_update_address_inner;
}
